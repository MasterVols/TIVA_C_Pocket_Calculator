// TO RUN THE OLED DISPLAY WITH TIVA MC
// based on code from: https://microcontrollerslab.com/oled-interfacing-with-tm4c123g-display-texts-and-graphics/
...
//holds all different ASCII character representations:
...
void SystemInit(void)
{
	...
	#define SCB_CPACR (*((volatile uint32_t *)(SCB_BASE_ADDRESS + SCB_CPACR_OFFSET)))
